 ...
 * ```<custom-element ref={ og({ prop1: 'a' }, { event: () => this.handleEvent() }) }></custom-element>```
 ...
 * ```<custom-element ref={ el => { this.element = og({ prop1: 'a' }, { event: () => this.handleEvent() })(el); }></custom-element>```
