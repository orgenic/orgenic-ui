...
| `--og-expander-BorderRadius`          | Border radius of the expanders border       |
| `--og-expander-BorderWidth`           | Border width of the expanders border        |
| `--og-expander-Margin`                | Margin around the card                      |
| `--og-expander__content-Padding`      | Padding of the expanders content            |
| `--og-expander__header-BorderColor`   | Boder color of the expanders header border  |
| `--og-expander__header-BorderStyle`   | Boder style of the expanders header border  |
| `--og-expander__header-BorderWidth`   | Boder width of the expanders header border  |
| `--og-expander__header-FontSize`      | Font size of the expanders header           |
| `--og-expander__header-FontWeight`    | Font weight of the expanders header         |
