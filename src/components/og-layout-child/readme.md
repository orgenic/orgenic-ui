...
| Name                        | Description                  |
| --------------------------- | ---------------------------- |
| `--og-layout-child--align`  | align-self behavior          |
| `--og-layout-child--basis`  | flex-basis behavior          |
| `--og-layout-child--grow`   | flex-grow behavior           |
| `--og-layout-child--order`  | Order of the layout children |
| `--og-layout-child--shrink` | flex-shrink behavior         |
