...
| `multiLine`   | `multi-line`  | Determines, whether the control automatically grows downwards if the inserted text gets to big. | `boolean` | `false`     |
...
| `--og-input__wrapper-Margin`              | Margin around the wrapper element, which wraps the input field and the logic it needs for resizing itself |
