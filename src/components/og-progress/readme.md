...
| `buffer`        | `buffer`        | The percent value of the progress buffer                       | `number`            | `undefined`                       |
...
| `label`         | `label`         | The label of the progress                                      | `string`            | `undefined`                       |
...
| `size`          | `size`          | The size (height) of the progress bar                          | `"l" \| "m" \| "s"` | `'m'`                             |
